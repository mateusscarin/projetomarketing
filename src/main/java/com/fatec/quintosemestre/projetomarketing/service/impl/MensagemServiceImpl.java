...
public class MensagemServiceImpl implements MensagemService {
    ...
    public ResponseEntity<Object> cadastrar(MensagemDTO objeto) throws Exception {
        ...
        // Se um usuário tentar enviar uma mensagem em um chat que não é dele, lançar um erro
    ...
    public ResponseEntity<Object> listar() throws Exception {
        ...
        List<MensagemDTO> mensagem = mensagemMapper.converterParaListaDeDtos(mensagemRepository.findByUsuarioId(usuarioLogado.getId()));
        if (mensagem.isEmpty()) {
    ...
    public ResponseEntity<Object> editar(Long idObjeto, MensagemDTO objeto) throws Exception {
        ...
        // Se um usuário tentar editar uma mensagem em um chat que não é dele, lançar um erro
        if(!chat.getUsuarioAbertura().equals(usuarioLogado)) {
            throw new BadCredentialsException("Operação não autorizada");
        }
